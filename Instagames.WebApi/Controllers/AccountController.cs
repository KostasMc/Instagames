...
using Instagames.WebApi.Results;
using Instagames.Entities;
using Instagames.RepositoryService;
using Instagames.WebApi.Models.AccountViewModels;

namespace Instagames.WebApi.Controllers
{
    [Authorize]
